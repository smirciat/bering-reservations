...
describe('Mail API:', function() {
  ...
  describe('GET /api/mails', function() {
    ...
    it('should respond with JSON array', function() {
      expect(mails).to.be.instanceOf(Array);
    });
  ...
  describe('POST /api/mails', function() {
    ...
    it('should respond with the newly created mail', function() {
      expect(newMail.name).to.equal('New Mail');
      expect(newMail.info).to.equal('This is the brand new mail!!!');
    });
  ...
  describe('GET /api/mails/:id', function() {
    ...
    it('should respond with the requested mail', function() {
      expect(mail.name).to.equal('New Mail');
      expect(mail.info).to.equal('This is the brand new mail!!!');
    });
  ...
  describe('PUT /api/mails/:id', function() {
    ...
    it('should respond with the updated mail', function() {
      expect(updatedMail.name).to.equal('Updated Mail');
      expect(updatedMail.info).to.equal('This is the updated mail!!!');
    });
