// Generated on 2018-08-07 using generator-angular-fullstack 3.8.0
'use strict';
  ...
  grunt.initConfig({
    ...
    copy: {
      dist: {
        ...
        //ttf and woff
        {
            cwd: '<%= yeoman.client %>/bower_components/components-font-awesome/webfonts',
            src: ['*.*'],
            dest: '<%= yeoman.dist %>/client/webfonts',
            expand: true
        }, 
        {
          expand: true,
